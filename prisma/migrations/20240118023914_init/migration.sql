/*
  ...
  - You are about to drop the `livechatmessage` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `livechatroom` table. If the table is not empty, all the data it contains will be lost.
