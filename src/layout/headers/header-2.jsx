    ...
    return (
        <>
            <header className="p-relative">
                ...
                <div className="tp-header-area header-area-space p-relative pt-20 pb-50 d-none d-xl-block"
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-xl-9 text-dark">
                                <div className="tp-contact-wapper d-flex justify-content-end">
                                    <div className="tp-header-contact d-none d-xl-block pr-40">
                                        <div className="tp-header-contact-icon d-flex align-items-center">
                                            <div><a href="#"><i className="fas fa-phone text-dark"></i></a></div>
                                            <div className="tp-header-icon-info text-dark">
                                                <label className='text-dark'>Make a call</label>
                                                <a className='text-dark' href="tel:+98565689656">
                                                    +985 656 896 56
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="tp-header-contact d-none d-xl-block">
                                        <div className="tp-header-contact-icon d-flex align-items-center">
                                            <div className='text-dark'><a className='text-dark' href="#"><i className="fal fa-envelope-open text-dark"></i></a></div>
                                            <div className="tp-header-icon-info">
                                                <label className='text-dark'>Email address</label>
                                                <a className='text-dark' href="mailto:info@webmail.com">
                                                    info@webmail.com
                                                </a>
                                            </div>
                                        </div>
                ...
                <div className="tp-header-2-mobile-area d-block d-xl-none" style={ { backgroundColor: "#84b544" } } >
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-6">
                                <div className="logo">
