...
const { about, title, info, features, sig_img, author, job_title, right_img } =
  about_content;
...
const AboutArea = () => {
  ...
  return (
    <>
      <div className="tp-about-area pt-120 pb-30">
          ...
          <div className="row">
            <div className="col-xl-6 col-lg-12">
              <div className="tp-about-wrapper tp-about-wrapper-2 pt-40 mb-40 pr-40">
                ...
                <div className="tp-about-fea-item">
                  <ul>
                    {homeData
                      ? homeData.data.benefit_by.map((feature, i) => (
                          <li key={i}>
                            <i className="fal fa-check"></i>
                            {feature.title_benefit}
                          </li>
                        ))
                      : ""}
                  </ul>
            ...
            <div className="col-xl-6 col-lg-12">
              <div className="tp-about-wapper2 pl-10">
                <img
                  src={`${url.PROFECTA_API_URL}/public/images/cms/homepages/${homeData?.data?.img}`}
                  alt="theme-pure"
                />
              </div>
            </div>
