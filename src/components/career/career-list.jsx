...
const ServiceArea = () => {
  ...
  const fetchData = async (pageNumber = 1, keywords = "") => {
    ...
    await axios
      .get(
        `https://testing.profectaperdana.com/api/job_vacancies?search=${keywords}&page=${page}`
      )
                  ...
                  job.map((item, i) => (
                    <div key={i} className="col-lg-4 col-md-6 rounded mb-50">
                      <div className="tpservices rounded">
                        <div
                          className="tpservices__content shadow"
                          style={{ backgroundColor: "#f9fff4", height: "40vh" }}
                        >
                          <i
                            style={{ color: "#84b544" }}
                        ...
                        <div className="tpservices__btn shadow">
                          <Link href={`/career-detail/${item.unique_id}`}>
                            <button className="tp-btn w-100 rounded" href="#">
                              Job Details{" "}
